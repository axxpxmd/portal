    ...
    const me = [function (e) {
        ...
        a("beforeInit", (() => {
            ...
            t.params.a11y.enabled && (() => {
                ...
                p = T(p), u = T(u), p && p.forEach((t => g(t, r, e.nextSlideMessage))), u && u.forEach((t => g(t, r, e.prevSlideMessage))), f() && T(t.pagination.el).forEach((e => {
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    d.style.zIndex = -Math.abs(Math.round(c)) + e.length, ce(0, d).style.transform = S
                }
            },
            setTransition: e => {
                const s = t.slides.map((e => h(e)));
